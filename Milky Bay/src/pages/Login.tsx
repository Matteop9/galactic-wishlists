...
/* Username + password auth for a fixed group. Accounts are SHARED with The
   ...
   links their Milky Bay name on the /link screen. */
    ...
    <div className="mx-auto flex min-h-dvh max-w-[480px] flex-col justify-center px-6 py-8">
      ...
      <div className="rounded-[14px] bg-surface p-5">
        ...
        <p className="mt-3 text-center text-[11px] text-muted">
          {mode === 'signin'
            ? 'Already play The Acca? Sign in with the same username and password — you\'ll pick your Milky Bay name next.'
            : 'One account per player — and if you already have an Acca login, use Sign in instead (same account works here).'}
        </p>
      </div>
    </div>
  )
