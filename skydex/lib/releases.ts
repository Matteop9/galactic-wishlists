...
export const RELEASES: Release[] = [
  {
    ...
    date: "2026-09-03",
    changes: [
      "Skye gets out more. If you skipped the first-run guide you now get a one-time hello, she comments on about one ordinary catch in three (always on a big one), and every so often she drops a pointer for the page you are on — at most once every twenty minutes, never on the viewfinder, tap to dismiss.",
      "Her lines all live in one place and stay in the logbook voice: two short sentences, no emoji, and the same catch always gets the same line.",
    ],
  },
  {
    version: "1.0.8",
    date: "2026-09-03",
    changes: [
      "Meet Skye. A small goggled bird who turns up at the quiet moments — the first-run guide, an empty logbook, a failed catch, the Monday recap, and a big catch — and never on the viewfinder. Switch her off any time under Settings → Your companion.",
      "Special delivery: the first time you log a special-livery airframe, the catch card says so and the livery joins the \"New\" chips.",
      "Repeat catches of a rare plane now say \"Caught!\" instead of \"New discovery\" — the celebration stays, the headline is honest.",
