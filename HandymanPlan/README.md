...
| **Properties** | Pipeline from *Scouting → Viewing → Offer → Buying → Renovating → Selling → Sold*. Each property has six sub-tabs: |
| — Deal | Country cost cheat-sheet + full deal calculator (buying costs %, reno budget, holding, selling costs → all-in, projected profit, ROI, break-even price) with estimates vs actuals |
...
- **[PLAYBOOK.md](PLAYBOOK.md)** — strategy notes: country-by-country costs and rules, the 90/180 problem and visa options, renovation cost benchmarks, classic traps
