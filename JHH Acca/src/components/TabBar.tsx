          ...
          {tabs.map((tab) =>
            tab ? (
              ...
              <div key="pick" className="relative flex justify-center">
                <NavLink
                  to="/pick"
                  className="cta absolute -top-[38px] flex h-11 w-11 items-center justify-center rounded-full bg-accent shadow-[0_4px_18px_rgba(180,227,61,0.35)] active:scale-95"
